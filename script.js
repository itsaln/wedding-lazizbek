...
const targetWeddingDate = new Date("2026-07-25T19:00:00+05:00").getTime();
...
const LOCALES = {
	ru: {
		pageTitle: "Лазизбек и Жасмина | Свадебное приглашение",
		metaDescription: "Свадебное приглашение Лазизбека и Жасмины на 25 июля 2026 года.",
		ariaIntro: "Конверт с приглашением",
		ariaEnvelope: "Запечатанный бумажный конверт",
		ariaWeddingDate: "Дата свадьбы",
		ariaCalendar: "Календарь июля 2026 с выделенным 25 июля",
		...
		withLove: "с любовью,",
		signatureNames: "Лазизбек\u00a0и\u00a0Жасмина",
		ornamentNames: "<span class=\"ornament-name-line\">Лазизбек</span><span class=\"ornament-name-amp\">и</span><span class=\"ornament-name-line\">Жасмина</span>",
		...
		venueName: "Ресторан Jasmina",
		venueAddress: "г. Камаши",
		venueLandmark: "Кашкадарья, Узбекистан",
		venueTime: "В 19:00",
	...
	uz: {
		pageTitle: "Lazizbek va Jasmina | To'y taklifnomasi",
		metaDescription: "Lazizbek va Jasminaning 2026-yil 25-iyuldagi to'y taklifnomasi.",
		ariaIntro: "Taklifnoma konverti",
		ariaEnvelope: "Muhrlangan qog'oz konvert",
		ariaWeddingDate: "To'y sanasi",
		ariaCalendar: "2026-yil iyul kalendari, 25-iyul belgilangan",
		...
		signatureNames: "Lazizbek\u00a0va\u00a0Jasmina",
		ornamentNames: "<span class=\"ornament-name-line\">Lazizbek</span><span class=\"ornament-name-amp\">va</span><span class=\"ornament-name-line\">Jasmina</span>",
		...
		venueName: "Jasmina restorani",
		venueAddress: "Qamashi sh.",
		venueLandmark: "Qashqadaryo, O'zbekiston",
	...
	en: {
		pageTitle: "Lazizbek and Jasmina | Wedding Invitation",
		metaDescription: "Wedding invitation of Lazizbek and Jasmina, July 25, 2026.",
		ariaIntro: "Invitation envelope",
		ariaEnvelope: "Sealed paper envelope",
		ariaWeddingDate: "Wedding date",
		ariaCalendar: "July 2026 calendar, July 25 highlighted",
		...
		withLove: "with love,",
		signatureNames: "Lazizbek\u00a0&\u00a0Jasmina",
		ornamentNames: "<span class=\"ornament-name-line\">Lazizbek</span><span class=\"ornament-name-amp\">&</span><span class=\"ornament-name-line\">Jasmina</span>",
		...
		weekdaySun: "Su",
		locationTitle: "Venue",
		venueName: "Jasmina Restaurant",
		venueAddress: "Qamashi city",
		venueLandmark: "Qashqadarya, Uzbekistan",
		venueTime: "At 19:00",
